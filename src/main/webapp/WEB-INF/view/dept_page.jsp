                ...
                <table class="pure-table" style="border: none;">
                    <td valign="top">
                        ...
                        <form class="pure-form">
                            <fieldset>
                                <legend>Dept Form(legacy)</legend>
                                <input type="text" name="id" value="${dept.id}"><p />
                                <input type="text" name="name" value="${dept.name}"><p />
                                <button type="submit" class="pure-button pure-button-primary">Submit</button>
                                    ...
                                    <tbody>
                                        <c:forEach var="dept" items="${dept_list}">
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/mvc/dept/${dept.id}">修改</a>
                                                </td>
                                                <td>
                                                    <a href="${pageContext.request.contextPath}/mvc/dept/delete/${dept.id}">刪除</a>
                                                </td>
                                                <td>
